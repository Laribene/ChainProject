...
void ChainController::start(void)
   {
    ...
    while(escolha)
    {
        ...
        switch(escolha)
        {
            case 1: { string buffer;cout << "String ......: "; getline(cin, buffer);loadData(buffer);};verificaStringDigitado =1; break;
            case 2: { createElements();  }; break;
            case 3: {
                if(!verificaStringDigitado){
...
vector<string> opcoes({  "Exit",
    ...
    while(escolha)
    {
        ...
        switch(escolha)
        {
            ...
            case 4: { chainUnits.push_back(make_shared<InitialElement>(InitialElement()));}break;
            ...
            case 8: {
                ...
                chainUnits.push_back(make_shared<InitialElement>(InitialElement()));
